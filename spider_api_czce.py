...
def spider(codename, firstdate):
    ...
    for i in range(len(date_range)):
        ...
        url = 'http://www.czce.com.cn/portal/DFSStaticFiles/Future/'+str(year)+'/'+str(year)+str_month+str_day+'/FutureDataDailyMA.txt'
        ...
        if len(rows) == 0:
            ...
            for nbrRow in range(2,len(rows)):
                ...
                #for column in colums_of_row:
                #    column_res.extend(column.split())
