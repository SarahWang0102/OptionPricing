...
#pct_cont = [0.03,0.04,0.05,0.06,0.07]
    ...
    while begin_date < begin_date2:
        ...
        while begDate < endDate:
            ...
            for t in intraday_etf.index:
                ...
                condition1 = abs(barrier-s)<0.01 and abs(marked-s)>0.0075 and min(hist_spots)>barrier
...
#print(df)
df.to_csv(os.path.abspath('..')+'/results/delta_hedge_downin_8-12.csv')