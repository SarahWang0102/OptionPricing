...
#f_vega = pu.get_figure(list(spot_range),[barrier_vegas,plain_vegas],[barrier_type,'plain vanilla call'],'spot','Gamma')
#f_vega.savefig(barrier_type+' delta.png',dpi = 300,format='png')
