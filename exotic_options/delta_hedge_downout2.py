...
for pct in barrier_cont:
    ...
    while begDate < endDate:
        ...
        #    begDate, daily_close, delta_svi, cash_svi, price_svi, pnl_svi / init_svi,
        #    pnl_bs / init_bs, replicate_svi))
...
print(df)
df.to_csv(os.path.abspath('..')+'/results/delta_hedge_downout.csv')