...
with open(os.getcwd()+'/intermediate_data/hedging_daily_params_puts.pickle','wb') as f:
    pickle.dump([daily_params],f)
with open(os.getcwd()+'/intermediate_data/hedging_dates_puts.pickle','wb') as f:
    pickle.dump([dates],f)
with open(os.getcwd()+'/intermediate_data/hedging_daily_svi_dataset_puts.pickle','wb') as f:
